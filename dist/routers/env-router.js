...
function EnvEditRouter(_a) {
    ...
    function envParser(req, options) {
        ...
        return __assign({ csv: csv }, __assign(__assign(__assign({}, defaultOptions), options), { dataname: req.params[0], maxRow: maxRow + 1, maxCol: maxCol + 1, colSize: colSize, rowSize: rowSize }));
    }
...
function EnvViewRouter(_a) {
    ...
    function envParser(req, options) {
        ...
        return __assign({ csv: csv }, __assign(__assign(__assign({}, defaultOptions), options), { dataname: req.params[0], maxRow: maxRow + 1, maxCol: maxCol + 1, rowSize: rowSize, colSize: colSize }));
    }
    router.get("/*", function (req, res) {
        var data = envParser(req, {
            rowSize: rowSize,
